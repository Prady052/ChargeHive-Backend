...
public class JwtUtils {
	...
	public void init() {
		...
		//generates simple secret string for the complex cryptographic work of signing and verifying tokens.
		//must be same in auth and gateway for successful validation
